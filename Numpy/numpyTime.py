...
import numpy as np
import time
numpy_array1 = np.random.randint(0,100,size=10000)#creating array of size 10000 of random integers between 0 and 100(exclusive)"""
numpy_array2 = np.random.randint(0,100,size=10000)#same
